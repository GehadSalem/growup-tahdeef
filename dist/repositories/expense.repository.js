...
var ExpenseRepository = /** @class */ (function () {
    function ExpenseRepository() {
        this.repository = data_source_1.AppDataSource.getRepository(Expense_entity_1.Expense);
    }
    ExpenseRepository.prototype.create = function (expenseData) {
        return __awaiter(this, void 0, void 0, function () {
            var expense;
            return __generator(this, function (_a) {
                expense = this.repository.create(expenseData);
                return [2 /*return*/, this.repository.save(expense)];
            });
        });
    };
    ExpenseRepository.prototype.findByUserId = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    ExpenseRepository.prototype.findByUserAndMonth = function (userId, month, year) {
        return __awaiter(this, void 0, void 0, function () {
