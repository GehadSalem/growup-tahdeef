...
var UserRepository = /** @class */ (function () {
    ...
    UserRepository.prototype.findOne = function () {
    ...
    UserRepository.prototype.findByEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.repository.findOne({ where: { email: email } })];
            });
        });
    };
    ...
    UserRepository.prototype.update = function (id, updateData) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    UserRepository.prototype.updateMonthlyIncome = function (id, income) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.update(id, { monthlyIncome: income })];
            });
        });
    };
    UserRepository.prototype.updateNotificationToken = function (id, token) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.update(id, { notificationToken: token })];
            });
        });
    };
