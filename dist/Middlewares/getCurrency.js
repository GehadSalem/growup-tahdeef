    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, axios_1.default.get("https://ipapi.co/".concat(ip, "/json/"))];
            case 1:
                response = _a.sent();
            ...
            case 2:
                ...
                if (err_1 instanceof Error) {
                    console.error('Currency detection failed:', err_1.message);
                }
                else {
                    console.error('Currency detection failed:', err_1);
                }
