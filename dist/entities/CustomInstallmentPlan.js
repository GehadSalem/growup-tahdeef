...
let CustomInstallmentPlan = class CustomInstallmentPlan {
};
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => User_1.User, user => user.installmentPlans),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => MajorGoal_1.MajorGoal, goal => goal.linkedInstallments, {
        nullable: true,
        eager: true // Optional: automatically loads the relation
    }),
    __metadata("design:type", MajorGoal_1.MajorGoal)
], CustomInstallmentPlan.prototype, "linkedGoal", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => Installment_1.InstallmentPayment, payment => payment.installmentPlan),
...
exports.CustomInstallmentPlan = CustomInstallmentPlan = __decorate([
    (0, typeorm_1.Entity)()
