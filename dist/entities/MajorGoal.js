...
__decorate([
    (0, typeorm_1.ManyToOne)(() => User_1.User, user => user.majorGoals),
...
__decorate([
    (0, typeorm_1.OneToMany)(() => CustomInstallmentPlan_1.CustomInstallmentPlan, installment => installment.linkedGoal),
...
exports.MajorGoal = MajorGoal = __decorate([
    (0, typeorm_1.Entity)()
], MajorGoal);
